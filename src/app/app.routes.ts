...
export const routes: Routes = [
  ...
  },
  {
    path: 'customer',
    loadChildren: () =>
      import('./Customer_Pages/customers/customers.module').then(
        (m) => m.CustomersModule
      ),
  },
  {
    path: 'home-service',
    loadChildren: () =>
      import('./Customer_Pages/home-services/home-services.module').then(
  ...
  },
  {
    path: 'properties',
    loadChildren: () =>
      import('./Customer_Pages/properties/properties.module').then(
  ...
  },
  {
    path: 'legalServices',
    loadChildren: () =>
      import('./Customer_Pages/legal-services/legal-services.module').then(
        (m) => m.LegalServicesModule
      ),
  },
];